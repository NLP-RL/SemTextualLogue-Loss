...
models_folder = "multiwoz_models/semTextualLogue"
...
def calculate_loss(logits,work_dataset_tens,source_tens_len,target_tens_len,source_sentence,target_sentence):
    ...
    bert_semantic_score = calculate_bert_similarity(generated_sentence,target_sentence)
    bert_contanic_score = calculate_bert_similarity(generated_sentence,source_sentence)

    bert_score = 0.7*bert_semantic_score+0.3*bert_contanic_score
